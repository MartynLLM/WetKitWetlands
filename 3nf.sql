...
-- Insert PO4_P_filtr_mg_l values
INSERT INTO normalized_chemistry (waterbodyID, sampleID, inlet_outlet, parameter, value)
SELECT WaterbodyID, SampleID, InletOrOutlet, 'PO4_P_filtr_mg_l', PO4_P_filtr_mg_l
FROM water_samples
WHERE PO4_P_filtr_mg_l IS NOT NULL;
...
-- Insert Methanogens_sediment_sample values
INSERT INTO normalized_chemistry (waterbodyID, sampleID, inlet_outlet, parameter, value)
SELECT WaterbodyID, SampleID, InletOrOutlet, 'Methanogens_sediment_sample', Methanogens_sediment_sample
FROM water_samples
WHERE Methanogens_sediment_sample IS NOT NULL;
